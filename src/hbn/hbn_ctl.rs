...
pub type RTC_CTL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HBN_CTL_SPEC, u8, u8, 4, O>;
...
pub type PU_LDO18IO_AON_W<'a, const O: u8> = crate::BitWriter<'a, u32, HBN_CTL_SPEC, bool, O>;
...
pub type PU_DCDC_AON_W<'a, const O: u8> = crate::BitWriter<'a, u32, HBN_CTL_SPEC, bool, O>;
...
#[doc = "`reset()` method sets hbn_ctl to value 0x01d5_0020"]
