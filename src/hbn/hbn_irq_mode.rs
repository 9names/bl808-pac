...
pub type HBN_PIN_WAKEUP_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HBN_IRQ_MODE_SPEC, u8, u8, 4, O>;
#[doc = "Field `hbn_pin_wakeup_mask` reader - "]
pub type HBN_PIN_WAKEUP_MASK_R = crate::FieldReader<u16, u16>;
#[doc = "Field `hbn_pin_wakeup_mask` writer - "]
pub type HBN_PIN_WAKEUP_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HBN_IRQ_MODE_SPEC, u16, u16, 9, O>;
...
impl R {
    ...
    pub fn hbn_pin_wakeup_mask(&self) -> HBN_PIN_WAKEUP_MASK_R {
        HBN_PIN_WAKEUP_MASK_R::new(((self.bits >> 4) & 0x01ff) as u16)
    }
    #[doc = "Bits 13:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hbn_pin_wakeup_mask(&mut self) -> HBN_PIN_WAKEUP_MASK_W<4> {
...
#[doc = "`reset()` method sets hbn_irq_mode to value 0x0301_0005"]
impl crate::Resettable for HBN_IRQ_MODE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0301_0005;
}
