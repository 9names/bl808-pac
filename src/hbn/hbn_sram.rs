...
#[doc = "Field `reserved_0_5` reader - "]
pub type RESERVED_0_5_R = crate::FieldReader<u8, u8>;
...
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn reserved_0_5(&self) -> RESERVED_0_5_R {
        RESERVED_0_5_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
