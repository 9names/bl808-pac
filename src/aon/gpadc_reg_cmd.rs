...
pub type GPADC_RCAL_EN_R = crate::BitReader<bool>;
#[doc = "Field `gpadc_rcal_en` writer - "]
pub type GPADC_RCAL_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPADC_REG_CMD_SPEC, bool, O>;
...
pub type GPADC_MICBOOST_32DB_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPADC_REG_CMD_SPEC, bool, O>;
#[doc = "Field `reserved_24_26` reader - "]
pub type RESERVED_24_26_R = crate::FieldReader<u8, u8>;
...
pub type GPADC_SEN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPADC_REG_CMD_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[doc = "Bits 24:26"]
    #[inline(always)]
    pub fn reserved_24_26(&self) -> RESERVED_24_26_R {
        RESERVED_24_26_R::new(((self.bits >> 24) & 7) as u8)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpadc_rcal_en(&mut self) -> GPADC_RCAL_EN_W<17> {
        GPADC_RCAL_EN_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpadc_sen_test_en(&mut self) -> GPADC_SEN_TEST_EN_W<31> {
