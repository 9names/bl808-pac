...
pub type ACOMP0_TEST_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ACOMP_CTRL_SPEC, u8, u8, 2, O>;
#[doc = "Field `reserved_14_16` reader - "]
pub type RESERVED_14_16_R = crate::FieldReader<u8, u8>;
#[doc = "Field `acomp1_out_raw` reader - "]
pub type ACOMP1_OUT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `reserved_18` reader - "]
pub type RESERVED_18_R = crate::BitReader<bool>;
...
pub type ACOMP_VREF_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `acomp_vref_sel` writer - "]
pub type ACOMP_VREF_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ACOMP_CTRL_SPEC, u8, u8, 6, O>;
...
impl R {
    ...
    #[doc = "Bits 14:16"]
    #[inline(always)]
    pub fn reserved_14_16(&self) -> RESERVED_14_16_R {
        RESERVED_14_16_R::new(((self.bits >> 14) & 7) as u8)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    ...
    #[doc = "Bit 18"]
    #[inline(always)]
    pub fn reserved_18(&self) -> RESERVED_18_R {
        RESERVED_18_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    ...
    pub fn acomp_reserved(&self) -> ACOMP_RESERVED_R {
        ACOMP_RESERVED_R::new(((self.bits >> 30) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn acomp_vref_sel(&mut self) -> ACOMP_VREF_SEL_W<24> {
        ACOMP_VREF_SEL_W::new(self)
    }
    #[doc = "Bits 30:31"]
    #[inline(always)]
    #[must_use]
    pub fn acomp_reserved(&mut self) -> ACOMP_RESERVED_W<30> {
