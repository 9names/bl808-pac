...
#[doc = "Field `sf_ahb2sif_diswrap` reader - "]
pub type SF_AHB2SIF_DISWRAP_R = crate::BitReader<bool>;
#[doc = "Field `sf_ahb2sif_diswrap` writer - "]
pub type SF_AHB2SIF_DISWRAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_1_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn sf_ahb2sif_diswrap(&self) -> SF_AHB2SIF_DISWRAP_R {
        SF_AHB2SIF_DISWRAP_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sf_ahb2sif_diswrap(&mut self) -> SF_AHB2SIF_DISWRAP_W<23> {
        SF_AHB2SIF_DISWRAP_W::new(self)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
