...
pub type SF_AES_REGION_R0_START_R = crate::FieldReader<u32, u32>;
#[doc = "Field `sf_aes_region_r0_start` writer - "]
pub type SF_AES_REGION_R0_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_AES_R0_START_SPEC, u32, u32, 19, O>;
...
pub type SF_AES_REGION_R0_HW_KEY_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SF_AES_R0_START_SPEC, bool, O>;
...
impl R {
    ...
    pub fn sf_aes_region_r0_start(&self) -> SF_AES_REGION_R0_START_R {
        SF_AES_REGION_R0_START_R::new(self.bits & 0x0007_ffff)
    }
    #[doc = "Bits 19:28"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sf_aes_region_r0_start(&mut self) -> SF_AES_REGION_R0_START_W<0> {
