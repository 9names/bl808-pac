...
#[doc = "Field `sf_if_trig_wr_prot` reader - "]
pub type SF_IF_TRIG_WR_PROT_R = crate::BitReader<bool>;
#[doc = "Field `sf_if_trig_wr_prot` writer - "]
pub type SF_IF_TRIG_WR_PROT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_2_SPEC, bool, O>;
#[doc = "Field `sf_id_offset_lock` reader - "]
pub type SF_ID_OFFSET_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `sf_id_offset_lock` writer - "]
pub type SF_ID_OFFSET_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_2_SPEC, bool, O>;
#[doc = "Field `reserved_8_24` reader - "]
pub type RESERVED_8_24_R = crate::FieldReader<u32, u32>;
#[doc = "Field `sf_ahb2sif_remap_lock` reader - "]
pub type SF_AHB2SIF_REMAP_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `sf_ahb2sif_remap_lock` writer - "]
pub type SF_AHB2SIF_REMAP_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SF_CTRL_2_SPEC, bool, O>;
#[doc = "Field `sf_ahb2sif_remap` reader - "]
pub type SF_AHB2SIF_REMAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `sf_ahb2sif_remap` writer - "]
pub type SF_AHB2SIF_REMAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_CTRL_2_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn sf_if_trig_wr_prot(&self) -> SF_IF_TRIG_WR_PROT_R {
        SF_IF_TRIG_WR_PROT_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn sf_id_offset_lock(&self) -> SF_ID_OFFSET_LOCK_R {
        SF_ID_OFFSET_LOCK_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bits 8:24"]
    #[inline(always)]
    pub fn reserved_8_24(&self) -> RESERVED_8_24_R {
        RESERVED_8_24_R::new((self.bits >> 8) & 0x0001_ffff)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn sf_ahb2sif_remap_lock(&self) -> SF_AHB2SIF_REMAP_LOCK_R {
        SF_AHB2SIF_REMAP_LOCK_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bits 26:27"]
    #[inline(always)]
    pub fn sf_ahb2sif_remap(&self) -> SF_AHB2SIF_REMAP_R {
        SF_AHB2SIF_REMAP_R::new(((self.bits >> 26) & 3) as u8)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sf_if_trig_wr_prot(&mut self) -> SF_IF_TRIG_WR_PROT_W<6> {
        SF_IF_TRIG_WR_PROT_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn sf_id_offset_lock(&mut self) -> SF_ID_OFFSET_LOCK_W<7> {
        SF_ID_OFFSET_LOCK_W::new(self)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn sf_ahb2sif_remap_lock(&mut self) -> SF_AHB2SIF_REMAP_LOCK_W<25> {
        SF_AHB2SIF_REMAP_LOCK_W::new(self)
    }
    #[doc = "Bits 26:27"]
    #[inline(always)]
    #[must_use]
    pub fn sf_ahb2sif_remap(&mut self) -> SF_AHB2SIF_REMAP_W<26> {
        SF_AHB2SIF_REMAP_W::new(self)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
