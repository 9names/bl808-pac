...
#[doc = "Field `sf_if_32b_adr_en` reader - "]
pub type SF_IF_32B_ADR_EN_R = crate::BitReader<bool>;
#[doc = "Field `sf_if_32b_adr_en` writer - "]
pub type SF_IF_32B_ADR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_0_SPEC, bool, O>;
...
#[doc = "Field `sf_aes_din_endian` reader - "]
pub type SF_AES_DIN_ENDIAN_R = crate::BitReader<bool>;
#[doc = "Field `sf_aes_din_endian` writer - "]
pub type SF_AES_DIN_ENDIAN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_CTRL_0_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn sf_if_32b_adr_en(&self) -> SF_IF_32B_ADR_EN_R {
        SF_IF_32B_ADR_EN_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    ...
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn sf_aes_din_endian(&self) -> SF_AES_DIN_ENDIAN_R {
        SF_AES_DIN_ENDIAN_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sf_if_32b_adr_en(&mut self) -> SF_IF_32B_ADR_EN_W<19> {
        SF_IF_32B_ADR_EN_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn sf_aes_din_endian(&mut self) -> SF_AES_DIN_ENDIAN_W<21> {
        SF_AES_DIN_ENDIAN_W::new(self)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets sf_ctrl_0 to value 0x1af2_001c"]
impl crate::Resettable for SF_CTRL_0_SPEC {
    const RESET_VALUE: Self::Ux = 0x1af2_001c;
}
