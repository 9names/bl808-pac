...
#[doc = "Field `reserved_0_16` reader - "]
pub type RESERVED_0_16_R = crate::FieldReader<u32, u32>;
...
pub type SF_IF_3_CMD_BYTE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SF_IF_IAHB_6_SPEC, u8, u8, 3, O>;
#[doc = "Field `reserved_23_25` reader - "]
pub type RESERVED_23_25_R = crate::FieldReader<u8, u8>;
...
impl R {
    #[doc = "Bits 0:16"]
    #[inline(always)]
    pub fn reserved_0_16(&self) -> RESERVED_0_16_R {
        RESERVED_0_16_R::new(self.bits & 0x0001_ffff)
    }
    #[doc = "Bits 17:19"]
    #[inline(always)]
    ...
    #[doc = "Bits 23:25"]
    #[inline(always)]
    pub fn reserved_23_25(&self) -> RESERVED_23_25_R {
        RESERVED_23_25_R::new(((self.bits >> 23) & 7) as u8)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
...
#[doc = "`reset()` method sets sf_if_iahb_6 to value 0x8800_0000"]
impl crate::Resettable for SF_IF_IAHB_6_SPEC {
    const RESET_VALUE: Self::Ux = 0x8800_0000;
}
