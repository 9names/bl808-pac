...
#[doc = "Field `sf_aes_blk_mode` reader - "]
pub type SF_AES_BLK_MODE_R = crate::BitReader<bool>;
#[doc = "Field `sf_aes_blk_mode` writer - "]
pub type SF_AES_BLK_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_AES_SPEC, bool, O>;
#[doc = "Field `sf_aes_xts_key_opt` reader - "]
pub type SF_AES_XTS_KEY_OPT_R = crate::BitReader<bool>;
#[doc = "Field `sf_aes_xts_key_opt` writer - "]
pub type SF_AES_XTS_KEY_OPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SF_AES_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn sf_aes_blk_mode(&self) -> SF_AES_BLK_MODE_R {
        SF_AES_BLK_MODE_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn sf_aes_xts_key_opt(&self) -> SF_AES_XTS_KEY_OPT_R {
        SF_AES_XTS_KEY_OPT_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sf_aes_blk_mode(&mut self) -> SF_AES_BLK_MODE_W<3> {
        SF_AES_BLK_MODE_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn sf_aes_xts_key_opt(&mut self) -> SF_AES_XTS_KEY_OPT_W<4> {
        SF_AES_XTS_KEY_OPT_W::new(self)
    }
