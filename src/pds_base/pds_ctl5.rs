...
pub struct R(crate::R<PDS_CTL5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PDS_CTL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PDS_CTL5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PDS_CTL5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pds_ctl5` writer"]
pub struct W(crate::W<PDS_CTL5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PDS_CTL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PDS_CTL5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PDS_CTL5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CR_NP_WFI_MASK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDS_CTL5_SPEC, bool, O>;
...
pub type CR_MM_WFI_MASK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDS_CTL5_SPEC, bool, O>;
...
pub type CR_PICO_WFI_MASK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDS_CTL5_SPEC, bool, O>;
...
pub type CR_PDS_CTRL_USB33_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDS_CTL5_SPEC, bool, O>;
#[doc = "Field `cr_pds_pd_ldo18io` reader - "]
pub type CR_PDS_PD_LDO18IO_R = crate::BitReader<bool>;
#[doc = "Field `cr_pds_pd_ldo18io` writer - "]
pub type CR_PDS_PD_LDO18IO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDS_CTL5_SPEC, bool, O>;
...
pub type CR_PDS_GPIO_KEEP_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PDS_CTL5_SPEC, u8, u8, 3, O>;
...
#[doc = "PDS_CTL5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pds_ctl5](index.html) module"]
...
#[doc = "`reset()` method sets pds_ctl5 to value 0x0007_0000"]
