...
pub type RC32M_CLK_FORCE_ON_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RC32M_CTRL1_SPEC, bool, O>;
#[doc = "Field `reserved_5_23` reader - "]
pub type RESERVED_5_23_R = crate::FieldReader<u32, u32>;
...
impl R {
    ...
    #[doc = "Bits 5:23"]
    #[inline(always)]
    pub fn reserved_5_23(&self) -> RESERVED_5_23_R {
        RESERVED_5_23_R::new((self.bits >> 5) & 0x0007_ffff)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
...
#[doc = "`reset()` method sets rc32m_ctrl1 to value 0x0f00_0000"]
impl crate::Resettable for RC32M_CTRL1_SPEC {
    const RESET_VALUE: Self::Ux = 0x0f00_0000;
}
