...
#[doc = "Field `tzc_psramb_tzsrg_adr_mask` writer - "]
pub type TZC_PSRAMB_TZSRG_ADR_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_PSRAMB_TZSRG_ADR_MASK_SPEC, u16, u16, 16, O>;
#[doc = "Field `tzc_psramb_tzsrg_adr_mask_lock` reader - "]
pub type TZC_PSRAMB_TZSRG_ADR_MASK_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `tzc_psramb_tzsrg_adr_mask_lock` writer - "]
pub type TZC_PSRAMB_TZSRG_ADR_MASK_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_PSRAMB_TZSRG_ADR_MASK_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_psramb_tzsrg_adr_mask(&mut self) -> TZC_PSRAMB_TZSRG_ADR_MASK_W<0> {
        TZC_PSRAMB_TZSRG_ADR_MASK_W::new(self)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_psramb_tzsrg_adr_mask_lock(&mut self) -> TZC_PSRAMB_TZSRG_ADR_MASK_LOCK_W<16> {
        TZC_PSRAMB_TZSRG_ADR_MASK_LOCK_W::new(self)
    }
