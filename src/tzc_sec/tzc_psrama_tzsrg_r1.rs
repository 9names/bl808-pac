...
#[doc = "Field `tzc_psrama_tzsrg_r1_end` writer - "]
pub type TZC_PSRAMA_TZSRG_R1_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_PSRAMA_TZSRG_R1_SPEC, u16, u16, 16, O>;
#[doc = "Field `tzc_psrama_tzsrg_r1_start` reader - "]
pub type TZC_PSRAMA_TZSRG_R1_START_R = crate::FieldReader<u16, u16>;
#[doc = "Field `tzc_psrama_tzsrg_r1_start` writer - "]
pub type TZC_PSRAMA_TZSRG_R1_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_PSRAMA_TZSRG_R1_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_psrama_tzsrg_r1_end(&mut self) -> TZC_PSRAMA_TZSRG_R1_END_W<0> {
        TZC_PSRAMA_TZSRG_R1_END_W::new(self)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_psrama_tzsrg_r1_start(&mut self) -> TZC_PSRAMA_TZSRG_R1_START_W<16> {
        TZC_PSRAMA_TZSRG_R1_START_W::new(self)
    }
