...
#[doc = "Field `tzc_vram_tzsrg_r2_end` writer - "]
pub type TZC_VRAM_TZSRG_R2_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_VRAM_TZSRG_R2_SPEC, u16, u16, 10, O>;
#[doc = "Field `reserved_10_15` reader - "]
pub type RESERVED_10_15_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tzc_vram_tzsrg_r2_start` reader - "]
pub type TZC_VRAM_TZSRG_R2_START_R = crate::FieldReader<u16, u16>;
#[doc = "Field `tzc_vram_tzsrg_r2_start` writer - "]
pub type TZC_VRAM_TZSRG_R2_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_VRAM_TZSRG_R2_SPEC, u16, u16, 10, O>;
...
impl R {
    ...
    #[doc = "Bits 16:25"]
    #[inline(always)]
    pub fn tzc_vram_tzsrg_r2_start(&self) -> TZC_VRAM_TZSRG_R2_START_R {
        TZC_VRAM_TZSRG_R2_START_R::new(((self.bits >> 16) & 0x03ff) as u16)
    }
    #[doc = "Bits 26:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_vram_tzsrg_r2_end(&mut self) -> TZC_VRAM_TZSRG_R2_END_W<0> {
        TZC_VRAM_TZSRG_R2_END_W::new(self)
    }
    #[doc = "Bits 16:25"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_vram_tzsrg_r2_start(&mut self) -> TZC_VRAM_TZSRG_R2_START_W<16> {
        TZC_VRAM_TZSRG_R2_START_W::new(self)
    }
