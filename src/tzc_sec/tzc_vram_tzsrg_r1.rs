...
#[doc = "Field `tzc_vram_tzsrg_r1_start` writer - "]
pub type TZC_VRAM_TZSRG_R1_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_VRAM_TZSRG_R1_SPEC, u16, u16, 10, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_vram_tzsrg_r1_start(&mut self) -> TZC_VRAM_TZSRG_R1_START_W<16> {
        TZC_VRAM_TZSRG_R1_START_W::new(self)
    }
