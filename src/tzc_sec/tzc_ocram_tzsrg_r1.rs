...
#[doc = "Field `tzc_ocram_tzsrg_r1_end` writer - "]
pub type TZC_OCRAM_TZSRG_R1_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_OCRAM_TZSRG_R1_SPEC, u16, u16, 10, O>;
...
#[doc = "Field `tzc_ocram_tzsrg_r1_start` writer - "]
pub type TZC_OCRAM_TZSRG_R1_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_OCRAM_TZSRG_R1_SPEC, u16, u16, 10, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_ocram_tzsrg_r1_end(&mut self) -> TZC_OCRAM_TZSRG_R1_END_W<0> {
        TZC_OCRAM_TZSRG_R1_END_W::new(self)
    }
    #[doc = "Bits 16:25"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_ocram_tzsrg_r1_start(&mut self) -> TZC_OCRAM_TZSRG_R1_START_W<16> {
        TZC_OCRAM_TZSRG_R1_START_W::new(self)
    }
