...
#[doc = "Field `tzc_sf_tzsrg_r0_end_msb` writer - "]
pub type TZC_SF_TZSRG_R0_END_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
#[doc = "Field `tzc_sf_tzsrg_r0_start_msb` writer - "]
pub type TZC_SF_TZSRG_R0_START_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
#[doc = "Field `tzc_sf_tzsrg_r1_end_msb` writer - "]
pub type TZC_SF_TZSRG_R1_END_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
#[doc = "Field `tzc_sf_tzsrg_r1_start_msb` writer - "]
pub type TZC_SF_TZSRG_R1_START_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
#[doc = "Field `tzc_sf_tzsrg_r2_end_msb` writer - "]
pub type TZC_SF_TZSRG_R2_END_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
#[doc = "Field `tzc_sf_tzsrg_r2_start_msb` writer - "]
pub type TZC_SF_TZSRG_R2_START_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
#[doc = "Field `tzc_sf_tzsrg_r3_end_msb` writer - "]
pub type TZC_SF_TZSRG_R3_END_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
#[doc = "Field `tzc_sf_tzsrg_r3_start_msb` writer - "]
pub type TZC_SF_TZSRG_R3_START_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_MSB_SPEC, u8, u8, 3, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r0_end_msb(&mut self) -> TZC_SF_TZSRG_R0_END_MSB_W<0> {
        TZC_SF_TZSRG_R0_END_MSB_W::new(self)
    }
    #[doc = "Bits 4:6"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r0_start_msb(&mut self) -> TZC_SF_TZSRG_R0_START_MSB_W<4> {
        TZC_SF_TZSRG_R0_START_MSB_W::new(self)
    }
    #[doc = "Bits 8:10"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r1_end_msb(&mut self) -> TZC_SF_TZSRG_R1_END_MSB_W<8> {
        TZC_SF_TZSRG_R1_END_MSB_W::new(self)
    }
    #[doc = "Bits 12:14"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r1_start_msb(&mut self) -> TZC_SF_TZSRG_R1_START_MSB_W<12> {
        TZC_SF_TZSRG_R1_START_MSB_W::new(self)
    }
    #[doc = "Bits 16:18"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r2_end_msb(&mut self) -> TZC_SF_TZSRG_R2_END_MSB_W<16> {
        TZC_SF_TZSRG_R2_END_MSB_W::new(self)
    }
    #[doc = "Bits 20:22"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r2_start_msb(&mut self) -> TZC_SF_TZSRG_R2_START_MSB_W<20> {
        TZC_SF_TZSRG_R2_START_MSB_W::new(self)
    }
    #[doc = "Bits 24:26"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r3_end_msb(&mut self) -> TZC_SF_TZSRG_R3_END_MSB_W<24> {
        TZC_SF_TZSRG_R3_END_MSB_W::new(self)
    }
    #[doc = "Bits 28:30"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r3_start_msb(&mut self) -> TZC_SF_TZSRG_R3_START_MSB_W<28> {
        TZC_SF_TZSRG_R3_START_MSB_W::new(self)
    }
