...
#[doc = "Field `tzc_mm_pwron_rst_tzsid_lock` writer - "]
pub type TZC_MM_PWRON_RST_TZSID_LOCK_W<'a, const O: u8> =
...
#[doc = "Field `tzc_mm_cpu0_reset_tzsid_lock` writer - "]
pub type TZC_MM_CPU0_RESET_TZSID_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_CTRL_2_SPEC, bool, O>;
#[doc = "Field `tzc_mm_sys_reset_tzsid_lock` reader - "]
pub type TZC_MM_SYS_RESET_TZSID_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `tzc_mm_sys_reset_tzsid_lock` writer - "]
pub type TZC_MM_SYS_RESET_TZSID_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_CTRL_2_SPEC, bool, O>;
#[doc = "Field `tzc_mm_cpu0_tzsid_lock` reader - "]
pub type TZC_MM_CPU0_TZSID_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `tzc_mm_cpu0_tzsid_lock` writer - "]
pub type TZC_MM_CPU0_TZSID_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_CTRL_2_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_pwron_rst_tzsid_lock(&mut self) -> TZC_MM_PWRON_RST_TZSID_LOCK_W<0> {
        TZC_MM_PWRON_RST_TZSID_LOCK_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_cpu0_reset_tzsid_lock(&mut self) -> TZC_MM_CPU0_RESET_TZSID_LOCK_W<1> {
        TZC_MM_CPU0_RESET_TZSID_LOCK_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_sys_reset_tzsid_lock(&mut self) -> TZC_MM_SYS_RESET_TZSID_LOCK_W<2> {
        TZC_MM_SYS_RESET_TZSID_LOCK_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_cpu0_tzsid_lock(&mut self) -> TZC_MM_CPU0_TZSID_LOCK_W<3> {
        TZC_MM_CPU0_TZSID_LOCK_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
