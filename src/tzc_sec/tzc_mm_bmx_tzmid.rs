...
#[doc = "Field `tzc_mmcpu_tzmid` writer - "]
pub type TZC_MMCPU_TZMID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_blai_tzmid` reader - "]
pub type TZC_BLAI_TZMID_R = crate::BitReader<bool>;
#[doc = "Field `tzc_blai_tzmid` writer - "]
pub type TZC_BLAI_TZMID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_codec_tzmid` reader - "]
pub type TZC_CODEC_TZMID_R = crate::BitReader<bool>;
#[doc = "Field `tzc_codec_tzmid` writer - "]
pub type TZC_CODEC_TZMID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_subsys_tzmid` reader - "]
pub type TZC_SUBSYS_TZMID_R = crate::BitReader<bool>;
#[doc = "Field `tzc_subsys_tzmid` writer - "]
pub type TZC_SUBSYS_TZMID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_x2ddma_tzmid` reader - "]
pub type TZC_X2DDMA_TZMID_R = crate::BitReader<bool>;
#[doc = "Field `tzc_x2ddma_tzmid` writer - "]
pub type TZC_X2DDMA_TZMID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_xdma_tzmid` reader - "]
pub type TZC_XDMA_TZMID_R = crate::BitReader<bool>;
#[doc = "Field `tzc_xdma_tzmid` writer - "]
pub type TZC_XDMA_TZMID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
...
#[doc = "Field `tzc_mmcpu_tzmid_sel` writer - "]
pub type TZC_MMCPU_TZMID_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_blai_tzmid_sel` reader - "]
pub type TZC_BLAI_TZMID_SEL_R = crate::BitReader<bool>;
#[doc = "Field `tzc_blai_tzmid_sel` writer - "]
pub type TZC_BLAI_TZMID_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_codec_tzmid_sel` reader - "]
pub type TZC_CODEC_TZMID_SEL_R = crate::BitReader<bool>;
#[doc = "Field `tzc_codec_tzmid_sel` writer - "]
pub type TZC_CODEC_TZMID_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_subsys_tzmid_sel` reader - "]
pub type TZC_SUBSYS_TZMID_SEL_R = crate::BitReader<bool>;
#[doc = "Field `tzc_subsys_tzmid_sel` writer - "]
pub type TZC_SUBSYS_TZMID_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_x2ddma_tzmid_sel` reader - "]
pub type TZC_X2DDMA_TZMID_SEL_R = crate::BitReader<bool>;
#[doc = "Field `tzc_x2ddma_tzmid_sel` writer - "]
pub type TZC_X2DDMA_TZMID_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
#[doc = "Field `tzc_xdma_tzmid_sel` reader - "]
pub type TZC_XDMA_TZMID_SEL_R = crate::BitReader<bool>;
#[doc = "Field `tzc_xdma_tzmid_sel` writer - "]
pub type TZC_XDMA_TZMID_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_MM_BMX_TZMID_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_mmcpu_tzmid(&mut self) -> TZC_MMCPU_TZMID_W<0> {
        TZC_MMCPU_TZMID_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_blai_tzmid(&mut self) -> TZC_BLAI_TZMID_W<1> {
        TZC_BLAI_TZMID_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_codec_tzmid(&mut self) -> TZC_CODEC_TZMID_W<2> {
        TZC_CODEC_TZMID_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_subsys_tzmid(&mut self) -> TZC_SUBSYS_TZMID_W<3> {
        TZC_SUBSYS_TZMID_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_x2ddma_tzmid(&mut self) -> TZC_X2DDMA_TZMID_W<4> {
        TZC_X2DDMA_TZMID_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_xdma_tzmid(&mut self) -> TZC_XDMA_TZMID_W<5> {
        TZC_XDMA_TZMID_W::new(self)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mmcpu_tzmid_sel(&mut self) -> TZC_MMCPU_TZMID_SEL_W<16> {
        TZC_MMCPU_TZMID_SEL_W::new(self)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_blai_tzmid_sel(&mut self) -> TZC_BLAI_TZMID_SEL_W<17> {
        TZC_BLAI_TZMID_SEL_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_codec_tzmid_sel(&mut self) -> TZC_CODEC_TZMID_SEL_W<18> {
        TZC_CODEC_TZMID_SEL_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_subsys_tzmid_sel(&mut self) -> TZC_SUBSYS_TZMID_SEL_W<19> {
        TZC_SUBSYS_TZMID_SEL_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_x2ddma_tzmid_sel(&mut self) -> TZC_X2DDMA_TZMID_SEL_W<20> {
        TZC_X2DDMA_TZMID_SEL_W::new(self)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_xdma_tzmid_sel(&mut self) -> TZC_XDMA_TZMID_SEL_W<21> {
        TZC_XDMA_TZMID_SEL_W::new(self)
    }
