...
#[doc = "Field `tzc_xram_tzsrg_r0_start` reader - "]
pub type TZC_XRAM_TZSRG_R0_START_R = crate::FieldReader<u16, u16>;
#[doc = "Field `tzc_xram_tzsrg_r0_start` writer - "]
pub type TZC_XRAM_TZSRG_R0_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_XRAM_TZSRG_R0_SPEC, u16, u16, 10, O>;
...
impl R {
    ...
    #[doc = "Bits 16:25"]
    #[inline(always)]
    pub fn tzc_xram_tzsrg_r0_start(&self) -> TZC_XRAM_TZSRG_R0_START_R {
        TZC_XRAM_TZSRG_R0_START_R::new(((self.bits >> 16) & 0x03ff) as u16)
    }
    #[doc = "Bits 26:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_xram_tzsrg_r0_start(&mut self) -> TZC_XRAM_TZSRG_R0_START_W<16> {
        TZC_XRAM_TZSRG_R0_START_W::new(self)
    }
