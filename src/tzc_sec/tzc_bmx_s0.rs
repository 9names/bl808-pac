...
#[doc = "Field `tzc_bmx_dma2_tzsid_lock` writer - "]
pub type TZC_BMX_DMA2_TZSID_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_BMX_S0_SPEC, bool, O>;
#[doc = "Field `tzc_bmx_pwr_tzsid_lock` reader - "]
pub type TZC_BMX_PWR_TZSID_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `tzc_bmx_pwr_tzsid_lock` writer - "]
pub type TZC_BMX_PWR_TZSID_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_BMX_S0_SPEC, bool, O>;
#[doc = "Field `tzc_bmx_sdh_tzsid_lock` reader - "]
pub type TZC_BMX_SDH_TZSID_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `tzc_bmx_sdh_tzsid_lock` writer - "]
pub type TZC_BMX_SDH_TZSID_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_BMX_S0_SPEC, bool, O>;
#[doc = "Field `tzc_bmx_emac_tzsid_lock` reader - "]
pub type TZC_BMX_EMAC_TZSID_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `tzc_bmx_emac_tzsid_lock` writer - "]
pub type TZC_BMX_EMAC_TZSID_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TZC_BMX_S0_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_bmx_dma2_tzsid_lock(&mut self) -> TZC_BMX_DMA2_TZSID_LOCK_W<18> {
        TZC_BMX_DMA2_TZSID_LOCK_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_bmx_pwr_tzsid_lock(&mut self) -> TZC_BMX_PWR_TZSID_LOCK_W<19> {
        TZC_BMX_PWR_TZSID_LOCK_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_bmx_sdh_tzsid_lock(&mut self) -> TZC_BMX_SDH_TZSID_LOCK_W<20> {
        TZC_BMX_SDH_TZSID_LOCK_W::new(self)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_bmx_emac_tzsid_lock(&mut self) -> TZC_BMX_EMAC_TZSID_LOCK_W<21> {
        TZC_BMX_EMAC_TZSID_LOCK_W::new(self)
    }
