...
#[doc = "Field `tzc_psramb_tzsrg_r2_end` writer - "]
pub type TZC_PSRAMB_TZSRG_R2_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_PSRAMB_TZSRG_R2_SPEC, u16, u16, 16, O>;
#[doc = "Field `tzc_psramb_tzsrg_r2_start` reader - "]
pub type TZC_PSRAMB_TZSRG_R2_START_R = crate::FieldReader<u16, u16>;
#[doc = "Field `tzc_psramb_tzsrg_r2_start` writer - "]
pub type TZC_PSRAMB_TZSRG_R2_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_PSRAMB_TZSRG_R2_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_psramb_tzsrg_r2_end(&mut self) -> TZC_PSRAMB_TZSRG_R2_END_W<0> {
        TZC_PSRAMB_TZSRG_R2_END_W::new(self)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_psramb_tzsrg_r2_start(&mut self) -> TZC_PSRAMB_TZSRG_R2_START_W<16> {
        TZC_PSRAMB_TZSRG_R2_START_W::new(self)
    }
