...
#[doc = "Field `tzc_mm_pwron_rst_tzsid_en` writer - "]
pub type TZC_MM_PWRON_RST_TZSID_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_MM_CTRL_0_SPEC, u8, u8, 2, O>;
#[doc = "Field `tzc_mm_cpu0_reset_tzsid_en` reader - "]
pub type TZC_MM_CPU0_RESET_TZSID_EN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tzc_mm_cpu0_reset_tzsid_en` writer - "]
pub type TZC_MM_CPU0_RESET_TZSID_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_MM_CTRL_0_SPEC, u8, u8, 2, O>;
#[doc = "Field `tzc_mm_sys_reset_tzsid_en` reader - "]
pub type TZC_MM_SYS_RESET_TZSID_EN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tzc_mm_sys_reset_tzsid_en` writer - "]
pub type TZC_MM_SYS_RESET_TZSID_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_MM_CTRL_0_SPEC, u8, u8, 2, O>;
#[doc = "Field `tzc_mm_cpu0_tzsid_en` reader - "]
pub type TZC_MM_CPU0_TZSID_EN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tzc_mm_cpu0_tzsid_en` writer - "]
pub type TZC_MM_CPU0_TZSID_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_MM_CTRL_0_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `tzc_mm_sram_tzsid_en` writer - "]
pub type TZC_MM_SRAM_TZSID_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_MM_CTRL_0_SPEC, u8, u8, 2, O>;
#[doc = "Field `tzc_mm_swrst_tzsid_en` reader - "]
pub type TZC_MM_SWRST_TZSID_EN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tzc_mm_swrst_tzsid_en` writer - "]
pub type TZC_MM_SWRST_TZSID_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_MM_CTRL_0_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `tzc_mm_clk_tzsid_en` writer - "]
pub type TZC_MM_CLK_TZSID_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_MM_CTRL_0_SPEC, u8, u8, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_pwron_rst_tzsid_en(&mut self) -> TZC_MM_PWRON_RST_TZSID_EN_W<0> {
        TZC_MM_PWRON_RST_TZSID_EN_W::new(self)
    }
    #[doc = "Bits 2:3"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_cpu0_reset_tzsid_en(&mut self) -> TZC_MM_CPU0_RESET_TZSID_EN_W<2> {
        TZC_MM_CPU0_RESET_TZSID_EN_W::new(self)
    }
    #[doc = "Bits 4:5"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_sys_reset_tzsid_en(&mut self) -> TZC_MM_SYS_RESET_TZSID_EN_W<4> {
        TZC_MM_SYS_RESET_TZSID_EN_W::new(self)
    }
    #[doc = "Bits 6:7"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_cpu0_tzsid_en(&mut self) -> TZC_MM_CPU0_TZSID_EN_W<6> {
        TZC_MM_CPU0_TZSID_EN_W::new(self)
    }
    #[doc = "Bits 10:11"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_sram_tzsid_en(&mut self) -> TZC_MM_SRAM_TZSID_EN_W<10> {
        TZC_MM_SRAM_TZSID_EN_W::new(self)
    }
    #[doc = "Bits 12:13"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_swrst_tzsid_en(&mut self) -> TZC_MM_SWRST_TZSID_EN_W<12> {
        TZC_MM_SWRST_TZSID_EN_W::new(self)
    }
    #[doc = "Bits 20:21"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_mm_clk_tzsid_en(&mut self) -> TZC_MM_CLK_TZSID_EN_W<20> {
        TZC_MM_CLK_TZSID_EN_W::new(self)
    }
