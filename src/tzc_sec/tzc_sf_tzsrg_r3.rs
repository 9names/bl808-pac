...
#[doc = "Field `tzc_sf_tzsrg_r3_end` writer - "]
pub type TZC_SF_TZSRG_R3_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_R3_SPEC, u16, u16, 16, O>;
#[doc = "Field `tzc_sf_tzsrg_r3_start` reader - "]
pub type TZC_SF_TZSRG_R3_START_R = crate::FieldReader<u16, u16>;
#[doc = "Field `tzc_sf_tzsrg_r3_start` writer - "]
pub type TZC_SF_TZSRG_R3_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_SF_TZSRG_R3_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r3_end(&mut self) -> TZC_SF_TZSRG_R3_END_W<0> {
        TZC_SF_TZSRG_R3_END_W::new(self)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    #[must_use]
    pub fn tzc_sf_tzsrg_r3_start(&mut self) -> TZC_SF_TZSRG_R3_START_W<16> {
        TZC_SF_TZSRG_R3_START_W::new(self)
    }
