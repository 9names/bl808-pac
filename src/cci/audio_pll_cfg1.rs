...
pub struct R(crate::R<AUDIO_PLL_CFG1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AUDIO_PLL_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AUDIO_PLL_CFG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AUDIO_PLL_CFG1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `audio_pll_cfg1` writer"]
pub struct W(crate::W<AUDIO_PLL_CFG1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AUDIO_PLL_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AUDIO_PLL_CFG1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AUDIO_PLL_CFG1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `aupll_postdiv` reader - "]
pub type AUPLL_POSTDIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_postdiv` writer - "]
pub type AUPLL_POSTDIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AUDIO_PLL_CFG1_SPEC, u8, u8, 7, O>;
#[doc = "Field `reserved_7` reader - "]
pub type RESERVED_7_R = crate::BitReader<bool>;
#[doc = "Field `aupll_refdiv_ratio` reader - "]
pub type AUPLL_REFDIV_RATIO_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_refdiv_ratio` writer - "]
pub type AUPLL_REFDIV_RATIO_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AUDIO_PLL_CFG1_SPEC, u8, u8, 4, O>;
#[doc = "Field `reserved_12_15` reader - "]
pub type RESERVED_12_15_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_refclk_sel` reader - "]
pub type AUPLL_REFCLK_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_refclk_sel` writer - "]
pub type AUPLL_REFCLK_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AUDIO_PLL_CFG1_SPEC, u8, u8, 2, O>;
#[doc = "Field `reserved_18_19` reader - "]
pub type RESERVED_18_19_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_vg11_sel` reader - "]
pub type AUPLL_VG11_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_vg11_sel` writer - "]
pub type AUPLL_VG11_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AUDIO_PLL_CFG1_SPEC, u8, u8, 2, O>;
#[doc = "Field `reserved_22_23` reader - "]
pub type RESERVED_22_23_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_vg13_sel` reader - "]
pub type AUPLL_VG13_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `aupll_vg13_sel` writer - "]
pub type AUPLL_VG13_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AUDIO_PLL_CFG1_SPEC, u8, u8, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aupll_postdiv(&mut self) -> AUPLL_POSTDIV_W<0> {
        AUPLL_POSTDIV_W::new(self)
    }
    #[doc = "Bits 8:11"]
    #[inline(always)]
    #[must_use]
    pub fn aupll_refdiv_ratio(&mut self) -> AUPLL_REFDIV_RATIO_W<8> {
        AUPLL_REFDIV_RATIO_W::new(self)
    }
    #[doc = "Bits 16:17"]
    #[inline(always)]
    #[must_use]
    pub fn aupll_refclk_sel(&mut self) -> AUPLL_REFCLK_SEL_W<16> {
        AUPLL_REFCLK_SEL_W::new(self)
    }
    #[doc = "Bits 20:21"]
    #[inline(always)]
    #[must_use]
    pub fn aupll_vg11_sel(&mut self) -> AUPLL_VG11_SEL_W<20> {
        AUPLL_VG11_SEL_W::new(self)
    }
    #[doc = "Bits 24:25"]
    #[inline(always)]
    #[must_use]
    pub fn aupll_vg13_sel(&mut self) -> AUPLL_VG13_SEL_W<24> {
        AUPLL_VG13_SEL_W::new(self)
    }
...
#[doc = "audio_pll_cfg1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [audio_pll_cfg1](index.html) module"]
...
#[doc = "`reset()` method sets audio_pll_cfg1 to value 0x0110_0412"]
impl crate::Resettable for AUDIO_PLL_CFG1_SPEC {
    const RESET_VALUE: Self::Ux = 0x0110_0412;
}
