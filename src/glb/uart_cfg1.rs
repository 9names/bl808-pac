#[doc = "Register `uart_cfg1` reader"]
pub struct R(crate::R<UART_CFG1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UART_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UART_CFG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UART_CFG1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `uart_cfg1` writer"]
pub struct W(crate::W<UART_CFG1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UART_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UART_CFG1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UART_CFG1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UART_SIG_0_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UART_CFG1_SPEC, u8, u8, 4, O>;
...
#[doc = "uart_cfg1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uart_cfg1](index.html) module"]
pub struct UART_CFG1_SPEC;
impl crate::RegisterSpec for UART_CFG1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uart_cfg1::R](R) reader structure"]
impl crate::Readable for UART_CFG1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart_cfg1::W](W) writer structure"]
impl crate::Writable for UART_CFG1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets uart_cfg1 to value 0x7654_3210"]
impl crate::Resettable for UART_CFG1_SPEC {
