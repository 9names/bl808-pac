...
#[doc = "Field `swrst_s1af` reader - "]
pub type SWRST_S1AF_R = crate::BitReader<bool>;
#[doc = "Field `swrst_s1af` writer - "]
pub type SWRST_S1AF_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWRST_CFG1_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn swrst_s1af(&self) -> SWRST_S1AF_R {
        SWRST_S1AF_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1af(&mut self) -> SWRST_S1AF_W<31> {
        SWRST_S1AF_W::new(self)
    }
