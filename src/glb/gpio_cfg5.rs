#[doc = "Register `gpio_cfg5` reader"]
pub struct R(crate::R<GPIO_CFG5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_CFG5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO_CFG5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_CFG5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `gpio_cfg5` writer"]
pub struct W(crate::W<GPIO_CFG5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_CFG5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO_CFG5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO_CFG5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REG_GPIO_5_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG5_SPEC, bool, O>;
#[doc = "Field `reg_gpio_5_smt` reader - "]
pub type REG_GPIO_5_SMT_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_5_smt` writer - "]
pub type REG_GPIO_5_SMT_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG5_SPEC, bool, O>;
...
pub type REG_GPIO_5_PU_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG5_SPEC, bool, O>;
#[doc = "Field `reg_gpio_5_pd` reader - "]
pub type REG_GPIO_5_PD_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_5_pd` writer - "]
pub type REG_GPIO_5_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG5_SPEC, bool, O>;
#[doc = "Field `reg_gpio_5_oe` reader - "]
pub type REG_GPIO_5_OE_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_5_oe` writer - "]
pub type REG_GPIO_5_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG5_SPEC, bool, O>;
...
impl R {
    ...
    pub fn reg_gpio_5_ie(&self) -> REG_GPIO_5_IE_R {
        REG_GPIO_5_IE_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn reg_gpio_5_smt(&self) -> REG_GPIO_5_SMT_R {
        REG_GPIO_5_SMT_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:3"]
    #[inline(always)]
    pub fn reg_gpio_5_drv(&self) -> REG_GPIO_5_DRV_R {
        REG_GPIO_5_DRV_R::new(((self.bits >> 2) & 3) as u8)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn reg_gpio_5_pu(&self) -> REG_GPIO_5_PU_R {
        REG_GPIO_5_PU_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn reg_gpio_5_pd(&self) -> REG_GPIO_5_PD_R {
        REG_GPIO_5_PD_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn reg_gpio_5_oe(&self) -> REG_GPIO_5_OE_R {
        REG_GPIO_5_OE_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    ...
    pub fn reg_gpio_5_func_sel(&self) -> REG_GPIO_5_FUNC_SEL_R {
        REG_GPIO_5_FUNC_SEL_R::new(((self.bits >> 8) & 0x1f) as u8)
    }
    #[doc = "Bits 13:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_5_ie(&mut self) -> REG_GPIO_5_IE_W<0> {
        REG_GPIO_5_IE_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_5_smt(&mut self) -> REG_GPIO_5_SMT_W<1> {
        REG_GPIO_5_SMT_W::new(self)
    }
    #[doc = "Bits 2:3"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_5_drv(&mut self) -> REG_GPIO_5_DRV_W<2> {
        REG_GPIO_5_DRV_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_5_pu(&mut self) -> REG_GPIO_5_PU_W<4> {
        REG_GPIO_5_PU_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_5_pd(&mut self) -> REG_GPIO_5_PD_W<5> {
        REG_GPIO_5_PD_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_5_oe(&mut self) -> REG_GPIO_5_OE_W<6> {
...
#[doc = "gpio_cfg5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_cfg5](index.html) module"]
pub struct GPIO_CFG5_SPEC;
impl crate::RegisterSpec for GPIO_CFG5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpio_cfg5::R](R) reader structure"]
impl crate::Readable for GPIO_CFG5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_cfg5::W](W) writer structure"]
impl crate::Writable for GPIO_CFG5_SPEC {
    type Writer = W;
