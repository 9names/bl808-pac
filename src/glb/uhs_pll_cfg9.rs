...
#[doc = "Field `uhspll_ssc_start_gate_en` reader - "]
pub type UHSPLL_SSC_START_GATE_EN_R = crate::BitReader<bool>;
#[doc = "Field `uhspll_ssc_start_gate_en` writer - "]
pub type UHSPLL_SSC_START_GATE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, UHS_PLL_CFG9_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn uhspll_ssc_start_gate_en(&self) -> UHSPLL_SSC_START_GATE_EN_R {
        UHSPLL_SSC_START_GATE_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bits 17:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uhspll_ssc_start_gate_en(&mut self) -> UHSPLL_SSC_START_GATE_EN_W<16> {
        UHSPLL_SSC_START_GATE_EN_W::new(self)
    }
...
#[doc = "`reset()` method sets uhs_pll_cfg9 to value 0x0001_5640"]
