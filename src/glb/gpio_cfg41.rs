...
#[doc = "Field `reg_gpio_41_set` writer - "]
pub type REG_GPIO_41_SET_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG41_SPEC, bool, O>;
#[doc = "Field `reg_gpio_41_clr` writer - "]
pub type REG_GPIO_41_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG41_SPEC, bool, O>;
#[doc = "Field `reserved_27` reader - "]
pub type RESERVED_27_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_41_i` reader - "]
pub type REG_GPIO_41_I_R = crate::BitReader<bool>;
#[doc = "Field `reserved_29` reader - "]
pub type RESERVED_29_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_41_mode` reader - "]
pub type REG_GPIO_41_MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `reg_gpio_41_mode` writer - "]
pub type REG_GPIO_41_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_CFG41_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    #[doc = "Bit 28"]
    #[inline(always)]
    pub fn reg_gpio_41_i(&self) -> REG_GPIO_41_I_R {
        REG_GPIO_41_I_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    ...
    #[doc = "Bits 30:31"]
    #[inline(always)]
    pub fn reg_gpio_41_mode(&self) -> REG_GPIO_41_MODE_R {
        REG_GPIO_41_MODE_R::new(((self.bits >> 30) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_41_set(&mut self) -> REG_GPIO_41_SET_W<25> {
        REG_GPIO_41_SET_W::new(self)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_41_clr(&mut self) -> REG_GPIO_41_CLR_W<26> {
        REG_GPIO_41_CLR_W::new(self)
    }
    #[doc = "Bits 30:31"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_41_mode(&mut self) -> REG_GPIO_41_MODE_W<30> {
        REG_GPIO_41_MODE_W::new(self)
    }
