#[doc = "Register `sys_cfg0` reader"]
pub struct R(crate::R<SYS_CFG0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SYS_CFG0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SYS_CFG0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SYS_CFG0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `sys_cfg0` writer"]
pub struct W(crate::W<SYS_CFG0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SYS_CFG0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SYS_CFG0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SYS_CFG0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REG_PLL_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SYS_CFG0_SPEC, bool, O>;
#[doc = "Field `reg_fclk_en` reader - "]
pub type REG_FCLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `reg_fclk_en` writer - "]
pub type REG_FCLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SYS_CFG0_SPEC, bool, O>;
#[doc = "Field `reg_hclk_en` reader - "]
pub type REG_HCLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `reg_hclk_en` writer - "]
pub type REG_HCLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SYS_CFG0_SPEC, bool, O>;
#[doc = "Field `reg_bclk_en` reader - "]
pub type REG_BCLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `reg_bclk_en` writer - "]
pub type REG_BCLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SYS_CFG0_SPEC, bool, O>;
#[doc = "Field `reserved_4_5` reader - "]
pub type RESERVED_4_5_R = crate::FieldReader<u8, u8>;
...
pub type REG_HCLK_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYS_CFG0_SPEC, u8, u8, 8, O>;
#[doc = "Field `reg_bclk_div` reader - "]
pub type REG_BCLK_DIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `reg_bclk_div` writer - "]
pub type REG_BCLK_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SYS_CFG0_SPEC, u8, u8, 8, O>;
...
impl R {
    ...
    #[doc = "Bits 4:5"]
    #[inline(always)]
    pub fn reserved_4_5(&self) -> RESERVED_4_5_R {
        RESERVED_4_5_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7"]
    #[inline(always)]
...
#[doc = "sys_cfg0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sys_cfg0](index.html) module"]
pub struct SYS_CFG0_SPEC;
impl crate::RegisterSpec for SYS_CFG0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sys_cfg0::R](R) reader structure"]
impl crate::Readable for SYS_CFG0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sys_cfg0::W](W) writer structure"]
impl crate::Writable for SYS_CFG0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets sys_cfg0 to value 0x0f"]
impl crate::Resettable for SYS_CFG0_SPEC {
