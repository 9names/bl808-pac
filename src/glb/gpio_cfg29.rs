...
#[doc = "Field `reg_gpio_29_int_mode_set` reader - "]
pub type REG_GPIO_29_INT_MODE_SET_R = crate::FieldReader<u8, u8>;
#[doc = "Field `reg_gpio_29_int_mode_set` writer - "]
pub type REG_GPIO_29_INT_MODE_SET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_CFG29_SPEC, u8, u8, 4, O>;
#[doc = "Field `reg_gpio_29_int_clr` reader - "]
pub type REG_GPIO_29_INT_CLR_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_29_int_clr` writer - "]
pub type REG_GPIO_29_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_CFG29_SPEC, bool, O>;
#[doc = "Field `gpio_29_int_stat` reader - "]
pub type GPIO_29_INT_STAT_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_29_int_mask` reader - "]
pub type REG_GPIO_29_INT_MASK_R = crate::BitReader<bool>;
#[doc = "Field `reg_gpio_29_int_mask` writer - "]
pub type REG_GPIO_29_INT_MASK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_CFG29_SPEC, bool, O>;
...
pub type REG_GPIO_29_O_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG29_SPEC, bool, O>;
#[doc = "Field `reg_gpio_29_set` writer - "]
pub type REG_GPIO_29_SET_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG29_SPEC, bool, O>;
#[doc = "Field `reg_gpio_29_clr` writer - "]
pub type REG_GPIO_29_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_CFG29_SPEC, bool, O>;
...
#[doc = "Field `reg_gpio_29_mode` reader - "]
pub type REG_GPIO_29_MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `reg_gpio_29_mode` writer - "]
pub type REG_GPIO_29_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_CFG29_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:19"]
    #[inline(always)]
    pub fn reg_gpio_29_int_mode_set(&self) -> REG_GPIO_29_INT_MODE_SET_R {
        REG_GPIO_29_INT_MODE_SET_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn reg_gpio_29_int_clr(&self) -> REG_GPIO_29_INT_CLR_R {
        REG_GPIO_29_INT_CLR_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn gpio_29_int_stat(&self) -> GPIO_29_INT_STAT_R {
        GPIO_29_INT_STAT_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    pub fn reg_gpio_29_int_mask(&self) -> REG_GPIO_29_INT_MASK_R {
        REG_GPIO_29_INT_MASK_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    ...
    pub fn reg_gpio_29_o(&self) -> REG_GPIO_29_O_R {
        REG_GPIO_29_O_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    ...
    pub fn reg_gpio_29_i(&self) -> REG_GPIO_29_I_R {
        REG_GPIO_29_I_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    ...
    #[doc = "Bits 30:31"]
    #[inline(always)]
    pub fn reg_gpio_29_mode(&self) -> REG_GPIO_29_MODE_R {
        REG_GPIO_29_MODE_R::new(((self.bits >> 30) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_29_int_mode_set(&mut self) -> REG_GPIO_29_INT_MODE_SET_W<16> {
        REG_GPIO_29_INT_MODE_SET_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_29_int_clr(&mut self) -> REG_GPIO_29_INT_CLR_W<20> {
        REG_GPIO_29_INT_CLR_W::new(self)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_29_int_mask(&mut self) -> REG_GPIO_29_INT_MASK_W<22> {
        REG_GPIO_29_INT_MASK_W::new(self)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_29_o(&mut self) -> REG_GPIO_29_O_W<24> {
        REG_GPIO_29_O_W::new(self)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_29_set(&mut self) -> REG_GPIO_29_SET_W<25> {
        REG_GPIO_29_SET_W::new(self)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_29_clr(&mut self) -> REG_GPIO_29_CLR_W<26> {
        REG_GPIO_29_CLR_W::new(self)
    }
    #[doc = "Bits 30:31"]
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_29_mode(&mut self) -> REG_GPIO_29_MODE_W<30> {
        REG_GPIO_29_MODE_W::new(self)
    }
...
#[doc = "`reset()` method sets gpio_cfg29 to value 0x0040_0b02"]
