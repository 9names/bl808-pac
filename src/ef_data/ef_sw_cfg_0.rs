...
#[doc = "Field `ef_sw_ai_dis` reader - "]
pub type EF_SW_AI_DIS_R = crate::BitReader<bool>;
#[doc = "Field `ef_sw_ai_dis` writer - "]
pub type EF_SW_AI_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EF_SW_CFG_0_SPEC, bool, O>;
#[doc = "Field `ef_sw_cpu0_dis` reader - "]
pub type EF_SW_CPU0_DIS_R = crate::BitReader<bool>;
#[doc = "Field `ef_sw_cpu0_dis` writer - "]
pub type EF_SW_CPU0_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EF_SW_CFG_0_SPEC, bool, O>;
...
pub type EF_SW_SBOOT_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_SW_CFG_0_SPEC, u8, u8, 2, O>;
#[doc = "Field `ef_sw_uart_dis` reader - "]
pub type EF_SW_UART_DIS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ef_sw_uart_dis` writer - "]
pub type EF_SW_UART_DIS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_SW_CFG_0_SPEC, u8, u8, 4, O>;
#[doc = "Field `ef_sw_ble2_dis` reader - "]
pub type EF_SW_BLE2_DIS_R = crate::BitReader<bool>;
#[doc = "Field `ef_sw_ble2_dis` writer - "]
pub type EF_SW_BLE2_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EF_SW_CFG_0_SPEC, bool, O>;
#[doc = "Field `ef_sw_m1542_dis` reader - "]
pub type EF_SW_M1542_DIS_R = crate::BitReader<bool>;
#[doc = "Field `ef_sw_m1542_dis` writer - "]
pub type EF_SW_M1542_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EF_SW_CFG_0_SPEC, bool, O>;
#[doc = "Field `ef_sw_sf_key_re_sel` reader - "]
pub type EF_SW_SF_KEY_RE_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ef_sw_sf_key_re_sel` writer - "]
pub type EF_SW_SF_KEY_RE_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EF_SW_CFG_0_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `ef_sw_btdm_dis` reader - "]
pub type EF_SW_BTDM_DIS_R = crate::BitReader<bool>;
#[doc = "Field `ef_sw_btdm_dis` writer - "]
pub type EF_SW_BTDM_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EF_SW_CFG_0_SPEC, bool, O>;
...
#[doc = "Field `ef_sw_m154_dis` reader - "]
pub type EF_SW_M154_DIS_R = crate::BitReader<bool>;
#[doc = "Field `ef_sw_m154_dis` writer - "]
pub type EF_SW_M154_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EF_SW_CFG_0_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn ef_sw_ai_dis(&self) -> EF_SW_AI_DIS_R {
        EF_SW_AI_DIS_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn ef_sw_cpu0_dis(&self) -> EF_SW_CPU0_DIS_R {
        EF_SW_CPU0_DIS_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 4:5"]
    #[inline(always)]
    ...
    #[doc = "Bits 6:9"]
    #[inline(always)]
    pub fn ef_sw_uart_dis(&self) -> EF_SW_UART_DIS_R {
        EF_SW_UART_DIS_R::new(((self.bits >> 6) & 0x0f) as u8)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    pub fn ef_sw_ble2_dis(&self) -> EF_SW_BLE2_DIS_R {
        EF_SW_BLE2_DIS_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn ef_sw_m1542_dis(&self) -> EF_SW_M1542_DIS_R {
        EF_SW_M1542_DIS_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 12:13"]
    #[inline(always)]
    pub fn ef_sw_sf_key_re_sel(&self) -> EF_SW_SF_KEY_RE_SEL_R {
        EF_SW_SF_KEY_RE_SEL_R::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    ...
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn ef_sw_btdm_dis(&self) -> EF_SW_BTDM_DIS_R {
        EF_SW_BTDM_DIS_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    ...
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn ef_sw_m154_dis(&self) -> EF_SW_M154_DIS_R {
        EF_SW_M154_DIS_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_ai_dis(&mut self) -> EF_SW_AI_DIS_W<2> {
        EF_SW_AI_DIS_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_cpu0_dis(&mut self) -> EF_SW_CPU0_DIS_W<3> {
        EF_SW_CPU0_DIS_W::new(self)
    }
    #[doc = "Bits 4:5"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_uart_dis(&mut self) -> EF_SW_UART_DIS_W<6> {
        EF_SW_UART_DIS_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_ble2_dis(&mut self) -> EF_SW_BLE2_DIS_W<10> {
        EF_SW_BLE2_DIS_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_m1542_dis(&mut self) -> EF_SW_M1542_DIS_W<11> {
        EF_SW_M1542_DIS_W::new(self)
    }
    #[doc = "Bits 12:13"]
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_sf_key_re_sel(&mut self) -> EF_SW_SF_KEY_RE_SEL_W<12> {
        EF_SW_SF_KEY_RE_SEL_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_btdm_dis(&mut self) -> EF_SW_BTDM_DIS_W<15> {
        EF_SW_BTDM_DIS_W::new(self)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ef_sw_m154_dis(&mut self) -> EF_SW_M154_DIS_W<19> {
        EF_SW_M154_DIS_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
